// Merkezi İkon Bileşenleri
// Kullanım: <Icon name="whatsapp" /> veya <WhatsAppIcon />
...
export function QuoteIcon({ size = 20, className = "" }) {
  return (
    <svg
      className={className}
      width={size}
...
export default function Icon({ name, size, className }) {
  switch (name) {
    ...
    case "quote":
      return <QuoteIcon size={size} className={className} />;
    case "phone":
